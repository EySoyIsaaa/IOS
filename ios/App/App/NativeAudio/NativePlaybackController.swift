...
final class NativePlaybackController {
    ...
    func play(trackId: String? = nil) -> [String: Any] {
        queue.sync {
            ...
            if let trackId = trackId?.nilIfBlank {
                ...
                queueManager.setQueue(trackIds: [track.id], startIndex: 0)
                return loadTrack(track, at: 0, requestId: requestId, shouldRestartLoadedTrack: false, skipOnFailure: true)
            }
    ...
    private func loadTrack(_ track: NativeTrack, at index: Int, requestId: String, shouldRestartLoadedTrack: Bool, skipOnFailure: Bool) -> [String: Any] {
